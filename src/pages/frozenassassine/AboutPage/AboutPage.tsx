...
import FriendItem from "@/components/frozenassassine/FriendItem/FriendItem";
        ...
        <div className={styles.aboutpage}>
            ...
            <div className={styles.friendslist}>
                <FriendItem
                    ...
                    name="Finn Freitag"
                    url="https://finnfreitag.com?ref=julius"
                    projects={[{description: "A very advanced calculator", name: "Calculator", url: "https://finnfreitag.com/tools/calculator?ref=julius"}]}
                ></FriendItem>
                <FriendItem
