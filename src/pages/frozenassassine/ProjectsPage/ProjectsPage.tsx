...
import ProjectItem from "@/components/frozenassassine/ProjectItem/ProjectItem";
    ...
    return (
        <div className={styles.projectspage}>
            <ProjectItem
                ...
                imageURL="./assets/frozenassassine/ultimate-runner-icon.png"
                buttons={[
            ...
            <ProjectItem
                ...
                imageURL="./assets/frozenassassine/neuralnetwork.jpg"
                buttons={[
            ...
            <ProjectItem
                ...
                imageURL="./assets/frozenassassine/quicknav.png"
                buttons={[
                    {
                        text: "Store",
                ...
                authors={[{name: "Finn Freitag", url: "https://finnfreitag.com?ref=julius"}, {name: "Julius Kirsch", url: "https://frozenassassine.de"}]}
            ></ProjectItem>
                        <ProjectItem
                headline="Ease Pass"
                ...
                imageURL="./assets/frozenassassine/easepass_banner.png"
                buttons={[
                    {
                        text: "Store",
            ...
            <ProjectItem
                ...
                imageURL="./assets/frozenassassine/fastedit_banner.jpg"
                buttons={[
                    {
                        text: "Store",
            ...
            <ProjectItem
                ...
                imageURL="./assets/frozenassassine/textcontrolbox_banner.jpg"
                buttons={[
                    {
                        text: "Nuget",
            ...
            <ProjectItemSmall
                ...
                // imageURL="./assets/frozenassassine/voiceassistant_banner.jpg"
                buttons={[
            ...
            <ProjectItemSmall
                ...
                // imageURL="./assets/frozenassassine/juli_banner.jpg"
                buttons={[
                    {
                        text: "Github",
